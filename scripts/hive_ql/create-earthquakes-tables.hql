...
PARTITIONED BY (magnitude_group string, year int) CLUSTERED BY (eq_id) SORTED BY (eq_id) into 4 buckets STORED AS orc TBLPROPERTIES('serialization.null.format'='');
